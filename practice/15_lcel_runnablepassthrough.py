...
chain_tools = chat_tempalte_tools | chat | string_output_parser | {'tools' : RunnablePassthrough() }
chain_strategy = chat_template_strategy  | chat | string_output_parser
...
# alternate - long chain
chain_combined = ( chat_tempalte_tools | chat | string_output_parser | {'tools' : RunnablePassthrough() } | 
